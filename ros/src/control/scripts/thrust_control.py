...
def _teleop(contr):
    ...
    desired_p_unramped[0] = contr.Z_axis
    desired_p_unramped[1] = contr.throttle
    desired_p_unramped[2] = contr.Rtrigger-contr.Ltrigger
    desired_p_unramped[3] = contr.x_axis
    desired_p_unramped[4] = contr.Y_axis
    desired_p_unramped[5] = 0.0
    print( "message")
